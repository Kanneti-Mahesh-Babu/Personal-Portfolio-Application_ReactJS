...
technologies.</p>
          ...
          <button className="btn btn-theme-outline"><a href='https://drive.google.com/file/d/1Jo3y_u19IHhRT-8b2YqByF_SU909xWaw/view?usp=sharing' style={{textDecoration:'none',color:'red'}} target='_blank' download> Download CV </a></button>
        </div>
      </div>
    </div>
    <div className="container py-5">
    ...
    <div className="container">
      ...
      <div className="row post-grid">
        <div className="col-md-6 col-lg-4 wow fadeInUp">
          <div className="card">
            <div className="img-place">
              <a href="https://mbemanagement.onrender.com" target='_blank'> <img src="../assets/img/work/ems.png" alt="" style={{height:'175px',width:'100%'}}/> </a>
            </div>
            <div className="caption">
              <a href="https://mbemanagement.onrender.com" target='_blank' className="post-category">Employees Management System Dashboard</a>
              <a href="https://mbemanagement.onrender.com" target='_blank' className="post-title">MongoDB, NodeJS, ReactJS, Material-UI.</a>
        ...
        <div className="col-md-6 col-lg-4 wow fadeInUp">
          <div className="card">
            <div className="img-place">
               <a href='https://mbtech.onrender.com' target='_blank'> <img src="../assets/img/work/portfolio.png" alt="" style={{height:'275px',width:'100%'}}/> </a>
            </div>
            <div className="caption">
              <a href="https://mbtech.onrender.com" target='_blank' className="post-category">ReactJS Portfolio Application</a>
              <a href="https://mbtech.onrender.com" target='_blank' className="post-title">ReactJS, JavaScript.</a>
